...
namespace SharpBIM.IssueTracker.Core.WPF.Views
{
    /// <summary>
    ...
    public partial class MainPage : SharpBIMUserControl, IAppViewModel
    {
        ...
        static MainPage()
        {
            AppGlobals.PlatformType = AppGlobals.PlatformType != SharpBIM.ServiceContracts.Enums.Platform.None ? AppGlobals.PlatformType : SharpBIM.ServiceContracts.Enums.Platform.VisualStudio;
        }
        public MainPage()
        {
